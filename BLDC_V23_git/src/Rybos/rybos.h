...
#define RYBOS_GENERATE_IRQ_STRING(STRING) 			#STRING,
#define RYBOS_GENERATE_TASK_STRING(STRING) 			#STRING,
...
typedef enum {
	...
	//ENUM decrementation
	RYBOS_NOT_USED1 = RYBOS_MARKER_IRQ_SIZE - 1,
	//Roll-out to all tasks
	RYBOS_TASK_LIST(RYBOS_GENERATE_TASK_ENUM)
	RYBOS_MARKER_TASK_SYSTEM,
	RYBOS_MARKER_TASK_SIZE = RYBOS_MARKER_TASK_SYSTEM - RYBOS_NOT_USED1,
} RybosIrqTaskMarker;
