...
//PID
CCMRAM_VARIABLE PID_DEF(pid_speed, BLDC_SPEED_PID_KP, BLDC_SPEED_PID_KI, BLDC_SPEED_PID_KD, BLDC_SPEED_PID_I_LIMIT, 0.0f);
CCMRAM_VARIABLE PID_DEF(pid_d, BLDC_PID_KP, BLDC_PID_KI, 0.0f, BLDC_PID_I_LIMIT * BLDC_MAX_DUTY, 0);
CCMRAM_VARIABLE PID_DEF(pid_q, BLDC_PID_KP, BLDC_PID_KI, 0.0f, BLDC_PID_I_LIMIT * BLDC_MAX_DUTY, 0);
