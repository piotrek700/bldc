...
#define DRV8301_PWM_3F_SWITCHING_FREQ_HZ			20000
#define DRV8301_PWM_PERIOD							(TICK_CPU_FREQUENCY_HZ / DRV8301_PWM_3F_SWITCHING_FREQ_HZ)
#define DRV8301_PWM_3F_DEAD_TIME_CYCLES				5
...
#define DRV8301_CR1_SETTINGS						( DRV8301_CR1_GATE_CURRENT_1P7A	  | DRV8301_CR1_GATE_RESET_NORMAL_MODE	| DRV8301_CR1_PWM_MODE_6PWM 	 | DRV8301_CR1_OCP_MODE_OC_LATCH_SHUT_DOWN	| DRV8301_CR1_OC_ADJ_SET_0P097 )
#define DRV8301_CR2_SETTINGS						( DRV8301_CR2_OCTW_MODE_OT_AND_OC | DRV8301_CR2_GAIN_80V 				| DRV8301_CR2_DC_CAL_CH1_CONNECT | DRV8301_CR2_DC_CAL_CH2_CONNECT			| DRV8301_CR2_OC_TOFF_CYCLE_By_CYCLE )
