...
#define DRV8301_PWM_3F_SWITCHING_FREQ_HZ			10000
...
#define DRV8301_CR1_SETTINGS						( DRV8301_CR1_GATE_CURRENT_1P7A	  | DRV8301_CR1_GATE_RESET_NORMAL_MODE	| DRV8301_CR1_PWM_MODE_6PWM 	 | DRV8301_CR1_OCP_MODE_OC_LATCH_SHUT_DOWN	| DRV8301_CR1_OC_ADJ_SET_0P403 )	//Gate drive peak current 1.7 A, 12.7A Current limit
