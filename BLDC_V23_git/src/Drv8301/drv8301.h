...
#define DRV8301_PWM_3F_SWITCHING_FREQ_HZ			15000		//Can be even 22kHz
...
#define DRV8301_PWM_3F_DEAD_TIME_25_CYCLES			0.17361111e-6f
#define DRV8301_PWM_3F_DEAD_TIME_150_CYCLES			1.1944e-6f
#define DRV8301_PWM_3F_DEAD_TIME_S					DRV8301_PWM_3F_DEAD_TIME_25_CYCLES
...
#define DRV8301_PWM_UPDATE_DISABLE					TIM1->CR1 |= TIM_CR1_UDIS
#define DRV8301_PWM_UPDATE_ENABLE					TIM1->CR1 &= ~TIM_CR1_UDIS
